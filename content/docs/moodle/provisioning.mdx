...
| POST | `/moodle/provision/courses/preview` | Multipart CSV preview (2 MB cap, `.csv` only) | — |
...
BulkCoursePreviewRequestDto {
  ...
  courses: CourseEntryDto[]  // non-empty, up to 500 entries
}
...
| GET | `/moodle/provision/tree/:categoryId/courses` | Live Moodle courses under a category (id of 1 or higher) |
