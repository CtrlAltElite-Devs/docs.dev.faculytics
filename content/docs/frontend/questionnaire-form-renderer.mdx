...
This section maps every new file to its correct location per the project's [feature-sliced architecture](/docs/ARCHITECTURE), with notes on where to hook things together.
