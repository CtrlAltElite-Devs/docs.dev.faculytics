...
The core ML pipeline. See [Pipeline](/docs/workers/topic-worker/pipeline) for details.

### `evaluate.py` — Quality Metrics

Computes five quality metrics on the fitted model. See [Metrics](/docs/workers/topic-worker/metrics) for details.
